package com.luizroberto.todosimple.security;
...
import com.luizroberto.todosimple.exceptions.GlobalExceptionHandler;
...
public class JWTAutenthicationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    HttpServletResponse response, FilterChain filterChain, Authentication authentication) throws IOException, ServletException{
        ...
        response.addHeader("acess-central-expose-headers", "Authorization");
    }
}
